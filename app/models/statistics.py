...
class Statistics:
    ...
    def top_medicines(limit=5):
        # СТАТИСТИКА: топ 5 популярних ліків
    ...
    def bookings_per_pharmacy():
        # СТАТИСТИКА: Бронювання по аптеках
        return Database.fetchall(
